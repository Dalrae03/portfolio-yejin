...
class ProjectRepositoryTest(
    @Autowired val projectRepository: ProjectRepository,  //의존성 주입 두개 받음
    ...
    private fun createProject(n: Int): Project {
        ...
        val skillsUsedInProject = skills.subList(0, n)  // 0부터 n-1까지 총 n개의 데이터 잘라옴
    ...
    fun beforeAll() {
        ...
        val skills = mutableListOf<Skill>()  //skill 받고
        for (i in 1..DATA_SIZE) {
            val skillTypes = SkillType.values()  //스킬 타입의 전체 데이터를 array로 준다.
